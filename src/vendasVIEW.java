...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    public void listarProdutosVendidos() {
        ...
        List<ProdutosDTO> listaProdutosVendidos = dao.listarVendas();

        String linhas[][] = new String[listaProdutosVendidos.size()][colunas.length];

        int i = 0;

        for (ProdutosDTO p : listaProdutosVendidos) {
            linhas[i] = new String[]{
